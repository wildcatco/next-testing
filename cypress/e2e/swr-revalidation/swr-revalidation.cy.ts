...
it("should refresh the shows page after 30 seconds", () => {
  ...
  cy.findAllByRole("heading", { name: /sold out/i }).should("have.length", 1);

  // buy all tickets for first show (id 0, 10)
  ...
  cy.findAllByRole("heading", { name: /sold out/i }).should("have.length", 2);
});
